...
LIBNET_API int WINAPI GetMacByIPv4Test(int argc, char ** argv);
...
LIBNET_API int WINAPI SendIcmpEcho(int argc, char ** argv);
LIBNET_API int WINAPI SendIcmpEcho2(int argc, char ** argv);
LIBNET_API DWORD WINAPI Icmp6Test();
LIBNET_API int WINAPI GetNetworkParamsTest();
...
LIBNET_API VOID WINAPI PrintDnsRecordList(PDNS_RECORD DnsRecord);
...
LIBNET_API int WINAPI AddIPv4Address(int argc, char ** argv);
LIBNET_API int WINAPI SetStaticIPv4(PCWSTR Ipv4, PCWSTR SubnetMask);
...
LIBNET_API int WINAPI IWinHttpRequestSend();
...
// LIBNET_API DWORD WINAPI RegisterProxyChangeNotification();
// LIBNET_API DWORD WINAPI UnregisterProxyChangeNotification();
LIBNET_API DWORD WINAPI SetDefaultProxyConfiguration();
LIBNET_API int WINAPI SetProxy();
LIBNET_API int WINAPI WriteProxySettings();
...
LIBNET_API int WINAPI EnumTcpTable2();
LIBNET_API int WINAPI EnumTcp6Table();
LIBNET_API int WINAPI EnumTcp6Table2();
LIBNET_API int WINAPI EnumTcpStatistics();
LIBNET_API int WINAPI EnumExtendedTcpTable(_In_ ULONG ulAf, _In_ TCP_TABLE_CLASS TableClass);
LIBNET_API int WINAPI RunEstats();
...
LIBNET_API int WINAPI EnumUdpTable();
LIBNET_API int WINAPI EnumUdp6Table();
LIBNET_API int WINAPI EnumExtendedUdpTable4();
LIBNET_API int WINAPI EnumExtendedUdpTable6();
...
LIBNET_API int WINAPI TestPersistentTcpPortReservation(int argc, WCHAR ** argv);
LIBNET_API int WINAPI GetPortReservation(int argc, WCHAR ** argv);
LIBNET_API int WINAPI TestLookupPersistentTcpPortReservation(int argc, WCHAR ** argv);
...
LIBNET_API BOOL WINAPI GetIPv4ByMac(_In_ PDL_EUI48 Mac, _Inout_ PIN_ADDR IPv4);
LIBNET_API int WINAPI EnumIpNetTable2(_In_ ADDRESS_FAMILY Family);
...
LIBNET_API int WINAPI EnumAdaptersAddressesInfo(_In_ ADDRESS_FAMILY Family);
...
LIBNET_API void WINAPI PacketizeSyn6(_In_ PDL_EUI48 SrcMac,
                                     _In_ PDL_EUI48 DesMac,
...
packetize_icmpv4_echo_request(_In_ PDL_EUI48 SrcMac, _In_ PDL_EUI48 DesMac, _In_ PIN_ADDR SourceAddress, _In_ PIN_ADDR DestinationAddress, _Out_ PBYTE buffer);

LIBNET_API void WINAPI
InitIpv6Header(_In_ PIN6_ADDR SourceAddress, _In_ PIN6_ADDR DestinationAddress, _In_ UINT8 NextHeader, _In_ UINT16 OptLen, _Out_ PIPV6_HEADER IPv6Header);
...
LIBNET_API _Ret_maybenull_ PVOID WINAPI PacketizeUdp4(_In_ PDL_EUI48 SrcMac,
                                                                  ...
                                                                  _In_ PIN_ADDR SourceAddress,
                                                                  _In_ PIN_ADDR DestinationAddress,
                                                                  _In_ WORD SourcePort,
                                                                  _In_ WORD DestinationPort,
...
LIBNET_API int WINAPI GettingFirewallSettings();
...
LIBNET_API _Ret_maybenull_
_Post_writable_byte_size_(16)
