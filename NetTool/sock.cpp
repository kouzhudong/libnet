...
*/
{
    ...
    get_ipv4_sock_opt(tcp, IPPROTO_IP);
    printf("\r\n\r\n\r\n");
    get_ipv4_sock_opt(udp, IPPROTO_IP);
    printf("\r\n\r\n\r\n");
    get_ipv4_sock_opt(ipv4, IPPROTO_IP);
    printf("\r\n\r\n\r\n");
...
int get_sol_sock_opt(_In_ SOCKET s)
{
   ...
   */
    ...
    */
    ...
    使用 SO_REUSE_UNICASTPORT) 选择的端口 (自动重用端口也会随机化返回的端口，因此，如果应用程序SO_REUSE_UNICASTPORT然后尝试设置SO_RANDOMIZE_PORT，则第二 个 setockopt
    调用将失败。
    */
    optLen = sizeof(int);
